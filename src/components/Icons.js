...
export const XIcon = ({ className, ...rest }) => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M17.77 2H21l-7.58 8.49L22 22h-7.55l-4.92-6.65L5.27 22H2.04l7.92-8.87L2 2h7.68l4.55 6.2L17.77 2Zm-1.2 2.15-4.08 4.6L7.6 4.15H4.95l5.9 7.43-6.15 6.88h2.57l4.3-4.8l5.38 6.05h2.6l-6.2-7.2l5.73-6.36h-2.5Z"
      />
    </svg>
  );
};
